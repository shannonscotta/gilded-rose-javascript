...
import { Basic, Legendary, Ticket, Cheese, Conjured, items, updateQuality } from "./gilded-rose.js";
...
describe("updateQuality", () => {
  ...
  it("degrades `quality` of basic Items twice as fast if `sellIn` days is less then zero.", () => {
